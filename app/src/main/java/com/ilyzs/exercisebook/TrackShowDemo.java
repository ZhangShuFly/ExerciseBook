...
/**
 * Created by zhangshu on 2018/4/12.
 */
...
public class TrackShowDemo extends BaseActivity {
    ...
    private void drawPolyLine() {
        ...
        markerOptions = new MarkerOptions().flat(true).anchor(0.5f, 0.5f)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.icon)).position(polylines.get(0))
    ...
    private static LatLng[] latlngs = new LatLng[]{
