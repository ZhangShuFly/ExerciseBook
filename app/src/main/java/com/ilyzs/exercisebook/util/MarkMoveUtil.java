...
/**
 * Created by zhangshu on 2018/4/11.
 */

public class MarkMoveUtil {
    //起始经度
    private  double sl0;// = 125.30227000000002;
    //起始纬度
    private  double slt;//= 43.88362;
    //结束点经度
    private  double el0;//= 129.40227000000002;
    //结束点纬度
    private  double elt;// = 49.68362;
    //决定小数点后取几位的参数
    private  double param;//= 1000;
    ...
    private double time_interval = 200;
     ...
     * @param elt
     */
    private  void getLatlngs(double sl0, double slt, double el0, double elt) {
        Log.e("CCC", el0 + ":" + elt);
        double a = elt - slt;
        double b = el0 - sl0;
        double c = a / param;
